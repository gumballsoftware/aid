 ...
 * @since 1.0.0
 */
public class KTMJsonReader implements DocumentReader {
	...
	public KTMJsonReader(Resource resource) {
		this(resource, new String[0]);
	}

	public KTMJsonReader(Resource resource, String... jsonKeysToUse) {
		this(resource, new EmptyJsonMetadataGenerator(), jsonKeysToUse);
	}

	public KTMJsonReader(Resource resource, JsonMetadataGenerator jsonMetadataGenerator, String... jsonKeysToUse) {
